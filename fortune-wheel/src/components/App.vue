	...
	<div>
			...
			<div class="modal-dialog modal-dialog-centered modal-lg">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-danger" data-bs-dismiss="modal" @click="onClaimReward">Ok</button>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="wheel-container">
			<div class="the_wheel" align="center" valign="center">
				<canvas id="canvas" width="434" height="582">
...
export const onLoadWheel = (dataReward) => {
	...
	function calculatePrize() {
		...
		const stopAngle = Math.floor(Math.random() * (minAngel + offset - minAngel + 1)) + minAngel;
...
export default {
	...
	async mounted() {
		...
		const dataReward = await fetch("https://social.lcnk.net/minigame/data/wheel.json").then((res) => res.json());
